...
/// terminal. Any terminal of that workspace is readable, the person's own
    ...
    serde_json::json!({
        ...
        "properties": {
            ...
            "lines": {
                ...
                "minimum": 1,
                "maximum": 200,
                "description": "How many of the grid's bottom lines to return, 1 to 200. Default 40."
            }
        },
        "required": ["terminalId"],
        "additionalProperties": false
