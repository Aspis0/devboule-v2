...
const freeSkill = MOCK_MARKETPLACE_ENTRIES.find((entry) => entry.id === "repo-rhythm");

if (freeSkill === undefined) {
  throw new Error('Marketplace fixture "repo-rhythm" is missing');
}

export const FREE_SKILL = freeSkill;
